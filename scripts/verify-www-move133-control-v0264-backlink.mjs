...
const receipt = JSON.parse(
  fs.readFileSync("public/receipts/ANTIMATTERIUM_WWW_MOVE133_CONTROL_V0264_BACKLINK.json", 'utf8')
);
...
const expected = {
  ...
  "move": 123,
  "surface": "www",
  "packageVersion": "0.1.75",
  "packageTag": "v0.1.75-antimatterium-www-control-v0264-backlink",
  "packageRelease": "https://github.com/ANTIMATTERIUM/WWW/releases/tag/v0.1.75-antimatterium-www-control-v0264-backlink",
  ...
  "backlinkId": "6aec669e8e7d8a915570c5c49fc2bbf78846b5ea38d7561989e9378ce8d59efc"
};
const outputPrefix = "ANTIMATTERIUM_WWW_MOVE133_CONTROL_V0264_BACKLINK";
